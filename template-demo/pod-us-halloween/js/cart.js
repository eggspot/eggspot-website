/* CASELAB® Halloween — cart drawer, quick-view modal, fly-to-cart. Depends on data.js */

const FREE_SHIP = 25;
const CART_KEY = 'caselab-hw-cart';
  ...
  if (!cart.length) {
    itemsEl.innerHTML = `
      <div class="cart-empty">
        ...
        <p class="mono-label" style="margin-top:6px">Free US shipping over $25</p>
      </div>`;
  } else {
...
const CROSS_SELL_IDS = ['jack-o-lantern-airpods', 'bat-carabiner', 'trick-or-treat-airpods'];
