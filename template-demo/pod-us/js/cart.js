/* CASELAB® — cart drawer, quick-view modal, fly-to-cart. Depends on data.js */

const FREE_SHIP = 35;
const CART_KEY = 'caselab-cart';
...
const CROSS_SELL_IDS = ['golden-hour-airpods', 'carabiner-clip', 'lime-static'];
