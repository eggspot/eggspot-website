/* CASELAB® — conversion psychology layer: cookie bar, exit-intent offer, no-signup wishlist. */
  ...
  el.innerHTML = `
    <div class="exit-offer__card">
      ...
      <form class="exit-offer__form" novalidate>
        ...
        <button class="btn btn--lime btn--block" type="submit">Claim My 10% Off</button>
      </form>
      <button class="exit-offer__decline" type="button" data-exit-close>No thanks, I'll pay full price</button>
      <p class="exit-offer__note mono-label">Free US shipping over $35 · 30-day free returns</p>
    </div>`;
...
function initExitOffer() {
  ...
  el.querySelector('form').addEventListener('submit', (e) => {
    ...
    el.querySelector('.exit-offer__card').innerHTML =
      '<p class="form-thanks form-thanks--dark" role="status">Check your inbox — code RADIX10 on its way!</p>';
